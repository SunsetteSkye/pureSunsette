...
; Characteristics of each move.
	...
	move GUILLOTINE,   NO_ADDITIONAL_EFFECT,       100, BUG,           70,  5 ; Sunsette: powerful, inaccurate, high-crit BUG move (was OHKO)
	...
	move GUST,         FLINCH_SIDE_EFFECT2,     	30, FLYING,       100, 20
	...
	move FURY_ATTACK,  BONEMERANG_EFFECT,           40, FLYING,       100, 20
	...
	move MIST,         MIST_EFFECT,                  0, ICE,          100, 30 ; priority
	...
	move BLIZZARD,     SWIFT_EFFECT      ,         100, ICE,          100,  5
	...
	move SUBMISSION,   CUT_DISABLE_EFFECT,          70, FIGHTING,     100, 10 ; Sunsette: damage + DISABLE
	move LOW_KICK,     FLINCH_SIDE_EFFECT2,         60, FIGHTING,     100, 20
	move COUNTER,      DRAIN_HP_EFFECT,             75, GHOST,   	  100, 10 ; -> DRAIN PUNCH
	...
	move QUICK_ATTACK, SWIFT_EFFECT,   	            70, NORMAL,       100, 10 ; priority move
	...
	move LICK,         PARALYZE_SIDE_EFFECT1,       30, GHOST,        100, 30
	...
	move SWIFT,        SWIFT_EFFECT,                50, ICE,          100, 20 ; -> COLD SNAP; priority move
	...
	move BARRAGE,      ATTACK_TWICE_EFFECT,         40, GHOST,        100, 20 ; -> SPIRIT BOMB
	...
	move FURY_SWIPES,  NO_ADDITIONAL_EFFECT,        45, GROUND,       100, 15 ; -> DUST CLAW
