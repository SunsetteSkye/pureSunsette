...
; Characteristics of each move.
	...
	move MEGA_PUNCH,   FLINCH_SIDE_EFFECT2,        100, FIGHTING,     100, 20 ; HAYMAKER
	...
	move NIGHT_SHADE,  PARALYZE_SIDE_EFFECT2,       70, GHOST,        100, 15 ; PHANTASM (was NIGHT STALK): rename only
	...
	move HAZE,         HAZE_EFFECT,                  0, POISON,       100, 30 ; BLACK HAZE
