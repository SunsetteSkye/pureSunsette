...
; Characteristics of each move.
	...
	move KARATE_CHOP,  NO_ADDITIONAL_EFFECT,        50, FIGHTING,     100, 20 ; high crit ratio; Sunsette: BP 40->50
	...
	move GUILLOTINE,   NO_ADDITIONAL_EFFECT,       100, BUG,           80,  5 ; Sunsette: powerful, inaccurate, high-crit BUG move (was OHKO) (EXTERMINATE); BP 80->100
	...
	move BIND,         FLINCH_SIDE_EFFECT2,         50, NORMAL,        85,  10 ; POWER BIND (was STONEBOUND): Sunsette trapping rework -> 30% flinch + guaranteed target -1 SPEED (SpeciesMoveBonus). "Wrap with higher BP."
	...
	move HORN_DRILL,   POISON_SIDE_EFFECT2,         90, POISON,        80,  5 ; -> VENOM DRILL ; high crit ratio; Sunsette: BP 75->90
	...
	move WATER_GUN,    WATERIFY_EFFECT,            40, WATER,        100, 20 ; SUPER SOAK - Sunsette: retypes the target to WATER
	...
	move GROWTH,       GROWTH_EFFECT,                0, GRASS,        100, 10 ; ADAPTATION (was FLOURISH): cure user's status + FLOURISH regen state + +1 ATTACK
	...
	move WITHDRAW,     WITHDRAW_EFFECT,              0, WATER,        100, 10 ; SHELL GAME (was SUBMERGE): WATERIFY the opponent + switch out (flee in wild) / take Reflect (ShellGameEffect_)
	...
	move CONSTRICT,    PARALYZE_SIDE_EFFECT2,       60, POISON,    100, 15 ; -> VENOM LASH (was STRANGLEVINE): POISON, 30% paralyze; 90 BP for TANGELA (RemappableMoves, kept); auto-crit vs statused added in CriticalHitTest
