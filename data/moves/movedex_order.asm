...
MovedexOrder:
	...
	db SPORE
	db STOMP
	db STORM_DRILL ; ZAPDOS
	db CONSTRICT ; VENOM LASH
	db STRENGTH
	db STRING_SHOT
	db STRUGGLE
	db STUN_SPORE
	...
	db VINE_WHIP
	db VICEGRIP ; LOCKJAW
	db WATER_GUN ; SUPER SOAK
	db WATERFALL
	db WHIRLWIND ; HURRICANE
	db WING_ATTACK
	db WINTER_GALE ; ARTICUNO
