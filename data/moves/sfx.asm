MoveSoundTable:
	...
	db SFX_POUND,              $00, $80 ; POUND (JOLT BOLT)
	...
	db SFX_BATTLE_13,          $00, $e0 ; WHIRLWIND (HURRICANE)
	...
	db SFX_BATTLE_0B,          $00, $40 ; ROAR (BELLOW)
	...
	db SFX_BATTLE_2F,          $50, $20 ; HAZE (BLACK HAZE)
	db SFX_NOT_VERY_EFFECTIVE, $f0, $10 ; REFLECT
	db SFX_BATTLE_25,          $00, $80 ; FOCUS_ENERGY
	db SFX_BATTLE_2F,          $50, $20 ; BIDE (BULK UP)
	db SFX_BATTLE_32,          $a2, $00 ; METRONOME
	db SFX_BATTLE_09,          $f2, $20 ; MIRROR_MOVE (MOCKINGBIRD)
	...
	db SFX_BATTLE_2A,          $20, $20 ; SLUDGE BOMB
	db SFX_BATTLE_32,          $00, $80 ; BONE_CLUB
	db SFX_BATTLE_29,          $1f, $20 ; FIRE_BLAST
	db SFX_BATTLE_2C,          $ff, $00 ; WATERFALL ; actually used for MIST (ETHEREAL)
	...
	db SFX_BATTLE_35,          $42, $01 ; DREAM_EATER (SOULSTEALER)
	...
	db SFX_BATTLE_0E,          $f0, $20 ; FURY_SWIPES (MUD CLAW)
