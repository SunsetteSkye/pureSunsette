...
FightingDojoMasterTMShop:
	script_mart TM_DEMOLISH, TM_FINISHER, TM_BODY_SLAM, TM_FROST_FIST, TM_BLAZE_HAMMER, TM_ZAPPERCUT, TM_BULK_UP ; Sunsette: TM_BULK_UP added (it lost its Brock home to BUNKER DOWN)
