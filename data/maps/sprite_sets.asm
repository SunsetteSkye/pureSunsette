...
SplitMapSpriteSets:
	...
	db NORTH_SOUTH, 50, SPRITESET_NERD_ROUTES, SPRITESET_LAVENDER     ; SPLITSET_ROUTE_10 (north has the super nerd)
	db EAST_WEST,   57, SPRITESET_VERMILION,       SPRITESET_SILENCE_BRIDGE  ; SPLITSET_ROUTE_11
	db NORTH_SOUTH, 21, SPRITESET_NERD_ROUTES,     SPRITESET_SILENCE_BRIDGE  ; SPLITSET_ROUTE_12 (north has the super nerd)
	...
	db EAST_WEST,    3, SPRITESET_SAFFRON,         SPRITESET_NERD_ROUTES     ; SPLITSET_ROUTE_8 (east has the super nerds)
...
; SPRITESET_NERD_ROUTES (Route 8 east, Route 10 north, Route 12 north — superneet super-nerd trainers)
; LAVENDER profile with LITTLE_GIRL swapped for SUPERNEET (same walking/still VRAM layout)
	db SPRITE_SUPERNEET
	db SPRITE_GIRL
	db SPRITE_SCRUFFY_GUY
	db SPRITE_HIKER
