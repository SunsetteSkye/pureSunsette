...
CeruleanCity_Object:
	...
	object_event 15, 18, SPRITE_SCRUFFY_GUY, WALK, UP_DOWN, TEXT_CERULEANCITY_SUPER_NERD1 
	object_event  9, 21, SPRITE_SCRUFFY_GUY, WALK, LEFT_RIGHT, TEXT_CERULEANCITY_SUPER_NERD2 
	...
	object_event  4, 12, SPRITE_SCRUFFY_GUY, STAY, DOWN, TEXT_CERULEANCITY_SUPER_NERD3
