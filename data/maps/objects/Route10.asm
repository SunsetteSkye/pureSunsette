...
Route10_Object:
	...
	def_object_events
	object_event 10, 44, SPRITE_SCRUFFY_GUY, STAY, LEFT, TEXT_ROUTE10_SUPER_NERD1, OPP_POKEMANIAC, 1
	object_event  3, 57, SPRITE_HIKER, STAY, UP, TEXT_ROUTE10_HIKER1, OPP_HIKER, 7
	object_event 14, 64, SPRITE_SCRUFFY_GUY, STAY, LEFT, TEXT_ROUTE10_SUPER_NERD2, OPP_POKEMANIAC, 2
	...
	object_event 13,  4, SPRITE_SUPERNEET, STAY, RIGHT, TEXT_ROUTE10_SUPER_NERD3, OPP_SUPER_NERD, 7
