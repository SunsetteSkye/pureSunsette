...
SafariZoneWest_Object:
	...
	object_event 21, 10, SPRITE_SCRUFFY_GUY, STAY, NONE, TEXT_SAFARIZONEWEST_BURGLAR, OPP_BURGLAR, 1
	object_event 22, 20, SPRITE_SCRUFFY_GUY, STAY, NONE, TEXT_SAFARIZONEWEST_POKEMANIAC, OPP_POKEMANIAC, 10
