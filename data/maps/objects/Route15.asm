...
Route15_Object:
	...
	object_event 48, 10, SPRITE_BIKERF, STAY, DOWN, TEXT_ROUTE15_BIKER1, OPP_BIKER_F, 4
	object_event 46, 10, SPRITE_BIKERF, STAY, DOWN, TEXT_ROUTE15_BIKER2, OPP_BIKER_F, 5
