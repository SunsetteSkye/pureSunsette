...
Route12_Object:
	...
	object_event 14, 76, SPRITE_SCRUFFY_GUY, STAY, UP, TEXT_ROUTE12_ROCKER, OPP_ROCKER, 2
	...
	object_event  4, 15, SPRITE_SCRUFFY_GUY, STAY, UP, TEXT_ROUTE12_TAMER, OPP_TAMER, 8
	object_event 17, 12, SPRITE_SUPERNEET, STAY, LEFT, TEXT_ROUTE12_SUPER_NERD, OPP_SUPER_NERD, 8
