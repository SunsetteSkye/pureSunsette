...
CinnabarGym_Object:
	...
	object_event 17,  2, SPRITE_SUPERNEET, STAY, DOWN, TEXT_CINNABARGYM_SUPER_NERD1, OPP_SUPER_NERD, 9
	object_event 17,  8, SPRITE_SCRUFFY_GUY, STAY, DOWN, TEXT_CINNABARGYM_BURGLAR1, OPP_BURGLAR, 4
	object_event 11,  4, SPRITE_SUPERNEET, STAY, DOWN, TEXT_CINNABARGYM_SUPER_NERD2, OPP_SUPER_NERD, 10
	object_event 11,  8, SPRITE_SCRUFFY_GUY, STAY, DOWN, TEXT_CINNABARGYM_BURGLAR2, OPP_BURGLAR, 5
	object_event 11, 14, SPRITE_GUARD, STAY, DOWN, TEXT_CINNERBARGYM_FIREFIGHTER1, OPP_FIREFIGHTER, 1
	object_event  3, 14, SPRITE_SCRUFFY_GUY, STAY, DOWN, TEXT_CINNABARGYM_BURGLAR3, OPP_BURGLAR, 6
