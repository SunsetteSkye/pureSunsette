...
PewterCity_Object:
	...
	object_event 27, 17, SPRITE_SCRUFFY_GUY, STAY, NONE, TEXT_PEWTERCITY_SUPER_NERD1 
	object_event 26, 25, SPRITE_SCRUFFY_GUY, WALK, LEFT_RIGHT, TEXT_PEWTERCITY_SUPER_NERD2 
