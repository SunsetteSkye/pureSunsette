...
Route14_Object:
	...
	object_event  5, 39, SPRITE_BIKERF, STAY, DOWN, TEXT_ROUTE14_BIKER1, OPP_BIKER_F, 2
	object_event  4, 30, SPRITE_BIKERF, STAY, RIGHT, TEXT_ROUTE14_BIKER2, OPP_BIKER_F, 3
