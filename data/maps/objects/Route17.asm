...
Route17_Object:
	...
	object_event  4, 18, SPRITE_BIKERF, STAY, UP, TEXT_ROUTE17_BIKER3, OPP_BIKER_F, 7
	object_event  7, 32, SPRITE_BIKERF, STAY, LEFT, TEXT_ROUTE17_BIKER4, OPP_BIKER_F, 8
	...
	object_event  5, 98, SPRITE_BIKERF, STAY, LEFT, TEXT_ROUTE17_BIKER9, OPP_BIKER_F, 9
	object_event 10, 118, SPRITE_BIKERF, STAY, DOWN, TEXT_ROUTE17_BIKER10, OPP_BIKER_F, 10
