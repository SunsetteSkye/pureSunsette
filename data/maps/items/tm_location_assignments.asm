...
; Gym Leader TMs
DEF TM_BROCK                                EQU TM_BIDE ; BULK UP
DEF TM_MISTY                                EQU TM_BUBBLEBEAM
DEF TM_SURGE                                EQU TM_THUNDERBOLT
DEF TM_ERIKA                                EQU TM_SOLARBEAM ; SOLAR CANNON
DEF TM_KOGA                                 EQU TM_TOXIC
DEF TM_SABRINA                              EQU TM_PSYWAVE ; Sunsette: Sabrina now gives the SKITTERMIND TM (was CALM MIND)
...
DEF TM_CELADON_MART_GAME_SHOP_GUY           EQU TM_SLAM         ; WASTEMAKER
DEF TM_ROUTE_16_FLY_HOUSE_FAMOUS_GIRL       EQU TM_SONICBOOM    ; ILL WIND
...
DEF TM_MT_MOON_B2F_DOWN_SECOND_LADDER       EQU TM_FURY_ATTACK ; MUD BOMB
...
DEF TM_ROUTE_11_SOUTHEAST_NEW               EQU TM_KARATE_CHOP
DEF TM_ROUTE_2_ABOVE_DIGLETT_CAVE_NEW       EQU TM_DISABLE
DEF TM_SS_ANNE_1F_ROOMS                     EQU TM_MEDITATE ; VOID MIND
DEF TM_SS_ANNE_B1F_ROOMS                    EQU TM_LOW_KICK ; Sunsette: was HI JUMP KICK; now the LOW KICK TM
DEF TM_ROUTE_9_SOUTH                        EQU TM_KINESIS 		; MIRAGE
DEF TM_ROCK_TUNNEL_B1F_SOUTHWEST_CORNER_NEW EQU TM_FIRE_PUNCH ; BLAZE HAMMER
DEF TM_HIDEOUT_B2F_ARROW_AREA_CENTER        EQU TM_BARRAGE ; SHADOW BALL
DEF TM_HIDEOUT_B3F_SOUTH_FROM_STAIRS        EQU TM_ICE_PUNCH ; FROST FIST
DEF TM_HIDEOUT_B4F_NORTH_FROM_B3F_STAIRS    EQU TM_BODY_SLAM
DEF TM_ROUTE_15_CUT_AREA_WEST               EQU TM_SLAM 		; WASTEMAKER
DEF TM_SILPH_CO_5F_SOUTHWEST                EQU TM_DOUBLE_EDGE
DEF TM_SILPH_CO_7F_EAST                     EQU TM_DRAGON_RAGE ; WYRM WRATH
...
DEF TM_ROUTE_12_SURF_DOCK                   EQU TM_ROLLING_KICK ; METEOR SWEEP
DEF TM_ROUTE_10_NEAR_POWER_PLANT_NEW        EQU TM_THUNDERBOLT
DEF TM_POWER_PLANT_SOUTH                    EQU TM_SLUDGE ; SLUDGE BOMB
...
DEF TM_MANSION_B1F_END_TABLE                EQU TM_SOLARBEAM ; SOLAR CANNON
DEF TM_SEAFOAM_ISLANDS_B4F_NEW              EQU TM_ICE_BEAM
DEF TM_VICTORY_ROAD_1F_NORTHEAST_TOP        EQU TM_SKY_ATTACK ; BRAVE BIRD
DEF TM_VICTORY_ROAD_2F_NORTHEAST            EQU TM_BLIZZARD
DEF TM_VICTORY_ROAD_2F_SOUTH_CENTER         EQU TM_SOLARBEAM ; SOLAR CANNON
