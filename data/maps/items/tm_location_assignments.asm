...
DEF TM_ERIKA                                EQU TM_SOLARBEAM
DEF TM_KOGA                                 EQU TM_TOXIC
DEF TM_SABRINA                              EQU TM_PSYWAVE ; Sunsette: Sabrina now gives the MINDWIPE TM (was AMNESIA)
...
DEF TM_ROUTE_12_GATE_2F_MOURNING_GIRL       EQU TM_SLAM 		; WASTEMAKER
DEF TM_CELADON_MART_GAME_SHOP_GUY           EQU TM_SONICBOOM    ; ILL WIND
...
DEF TM_ROUTE_11_SOUTHEAST_NEW               EQU TM_REFLECT
...
DEF TM_ROCK_TUNNEL_B1F_SOUTHWEST_CORNER_NEW EQU TM_FIRE_PUNCH
DEF TM_HIDEOUT_B2F_ARROW_AREA_CENTER        EQU TM_BARRAGE ; SHADOW BALL
DEF TM_HIDEOUT_B3F_SOUTH_FROM_STAIRS        EQU TM_ICE_PUNCH
...
DEF TM_MANSION_B1F_NEAR_FIRST_STATUE        EQU TM_BLIZZARD ; SLEET STORM
...
DEF TM_VICTORY_ROAD_2F_NORTHEAST            EQU TM_BLIZZARD ; SLEET STORM
