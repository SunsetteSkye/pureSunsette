...
; Learnset
	...
	db 19, SOFTBOILED
	db 22, SWORDS_DANCE
	db 24, SWIFT; COLD SNAP
	db 27, RAZOR_LEAF
	db 31, SOFTBOILED
	db 35, SONICBOOM; ILL WIND
	db 40, SKY_ATTACK
	db 45, PETAL_DANCE
	db 0
