...
; wObtainedBadges
	...
	const BIT_POISONBADGE    ; 4
	const BIT_PSYCHICBADGE   ; 5
...
; wMovementFlags
	...
	const BIT_FOLLOWER_ACTIVE  ; 3 ; Sunsette: the overworld follower OBJ occupies wShadowOAM sprites 36-39 this frame
